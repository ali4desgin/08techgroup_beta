...
@section("content")
    ...
    <form action="{{ url('/checkout/blockchain/confirm') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="list-group">
                    <li class="list-group-item">Wallet Address   <span class="pull-right">{{ $paymentAddress }}</span></li>
                    ...
                    <li class="list-group-item">Payment Amount   <span class="pull-right"> <span style="color:red">{{ $btc_value }}</span><b>BTC</b></span></li>
                    <li class="list-group-item"><input type="text" class="form-control input-lg" placeholder="Transaction Has" name="transactionhash"/></li>
                </ul>
            </div>
        </div>
